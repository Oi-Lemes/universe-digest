...
export const SignupEmail = ({
  ...
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Confirme seu email no Império dos Quadrinhos</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            Estamos quase lá! Confirme o email <strong style={strong}>{recipient}</strong>{' '}
            para liberar seu acesso ao maior acervo de HQs do Brasil.
          </Text>
